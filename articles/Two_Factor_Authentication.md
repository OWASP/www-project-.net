...
If you wish to add two factor authentication to your ASP.NET site you can use [http://www.asp.net/identity ASP.NET's Microsoft's Identity Framework] and [https://en.wikipedia.org/wiki/Google_Authenticator Google's "Authenticator"] app. A pre-prepared [https://www.nuget.org/packages/AddTwoFactorToMvc NuGet Package] by [http://lachlanbarclay.net Lachlan Barclay] is available which contains all the code you need. 
...
[[File:dotnet-2fa-auth3.png|change authentication]]


[[File:dotnet-2fa-auth4.png|change authentication 2]]


You should now have a very basic MVC app:


[[File:dotnet-2fa-auth5.png|basic MVC app]]
...
[[File:nuget-packagemanagerconsole.png|Opening the package manager]]
...
[[File:dotnet-2fa-auth6.png|Adding NuGet package]]
...
!Description
|-
|Content\authenticator-iphone-sample.png	
|Example image showing how to use the authenticator app
|-
|Controllers\AccountController.cs	
|Controller for managing all the account pages like registration, login, logout etc
|-
|Controllers\ManageController.cs	
|Controller for managing all of the “manage my account” pages
|-
|Scripts\qrcode.js	
|Javascript library for generating QR codes
|-
|TwoFactor\database-scripts\twofactor.sql	
|SQL script for creating tables in the DB
|-
|TwoFactor\readme.txt	
|Instructions for installing TwoFactor
|-
|Views\Account\*.cshtml	
|Pages handling registration, login, logout etc
|-
|Views\Manage\*.cshtml	
|Pages for the user to manage their account
|-
|Views\Shared\_LoginPartial.cshtml	
|Partial control used to display Registration/Login links 
|}
...
!Description
|-
|TwoFactor\classes\auth	
|Contains the code for two factor authentication
|-
|TwoFactor\classes\common	
|Common code used across multiple pages
|-
|TwoFactor\classes\models	
|ApplicationDb and ApplicationUser models
|-
|TwoFactor\classes\viewmodels	
|Viewmodels for Account and Manage pages 
|}
...
# SMTP Configuration
# Adding the Login Bar to your master page
...
[[File:dotnet-2fa-auth7.png|Login Bar]]
...
[[File:dotnet-2fa-auth8.png|Registering]]
...
# Your database user still has '''db_owner''' permission. You need to lower this.
# You need to encourage your users to use a complex password. You can add a “password strength meter”, using something like [https://github.com/ablanco/jquery.pwstrength.bootstrap JQuery Password Strength Meter], or you can add links to KeePass &amp; LastPass.
# At no point is any data (password or otherwise) transferred to or from google’s servers. The joy of the authenticator app is that you are (essentially) storing a password on your mobile, and your application knows how to work out if the one-time 30 second code is currently valid. There is no need to transmit the password over the wire. 
# Calling it "two factor authentication" is bad. Why? Most users see that phrase and go “I don’t know what that is, I’m not interested”. Calling it something like [https://www.facebook.com/notes/facebook-engineering/introducing-login-approvals/10150172618258920 Login Approvals] like facebook have is a much friendlier approach, and you will probably see much higher adoption!
# Adding functionality that says “you have recently logged in from a new/unknown device, if you don’t recognise it let us know” would be a great extra layer of security. A free system like [http://dev.maxmind.com/geoip/legacy/geolite MaxMind] might be useful, or a paid system like [http://ipinfo.io IpInfo] might help.
# If you are developing an internal enterprise system, training your users on basic security principles is definitely necessary. No sharing of passwords, lock your computer when you leave your desk, don’t plug in random USB sticks, etc etc.
# Protecting yourself from the [https://www.owasp.org/index.php/Top_10_2013-Top_10 top 10 most common security vulnerabilities] will go a long way to making your app more secure. No point in adding 2FA if your site is very easily hacked.  


==Other References==
[http://www.asp.net/identity/overview/features-api/two-factor-authentication-using-sms-and-email-with-aspnet-identity Two factor Auth using SMS and Email with ASP.NET Identity]
[http://www.jerriepelser.com/blog/using-google-authenticator-asp-net-identity Another take on Google Authenticator]
